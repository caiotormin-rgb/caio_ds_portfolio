...
>
>
> **ROLE CHANGED.** This memo assesses **Robyn's `dt_simulated_weekly`**,
...
*Resolved by fitting both ways and reporting the span.*
...
2. Does `newsletter` enter the model, and on which side of the reported span?
...
**Decision:** generate the dataset from a pre-registered DGP with a
