...
weeks** — the unsettled tail is excluded.
...
| Control | `category_demand`; **fit with and without**, span reported |
...
It is also what every open-source MMM tool defaults to, so this is standard
